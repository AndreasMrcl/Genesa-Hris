                    ...
                    <table id="myTable" class="w-full text-left">
                        <thead class="bg-gray-100 text-gray-600 text-sm leading-normal">
                            <tr>
                                ...
                                <th class="p-4 font-bold text-center">bpjs_kes_active</th>
                                <th class="p-4 font-bold">bpjs_tk_active</th>
                                <th class="p-4 font-bold">tax_method</th>
                                <th class="p-4 font-bold text-center">ump_amount</th>
                        ...
                        <tbody class="text-gray-700 text-sm">
                            ...
                            @foreach ($configs as $item)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4">
                                        <div class="font-bold text-gray-900">{{ $item->bpjs_jkk_rate ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
                                        <div class="font-bold text-gray-900">{{ $item->bpjs_kes_active ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
                                        <div class="font-bold text-gray-900">{{ $item->bpjs_tk_active ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
                                        <div class="font-bold text-gray-900">{{ $item->tax_method ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
                                        <div class="font-bold text-gray-900">{{ $item->ump_amount ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
