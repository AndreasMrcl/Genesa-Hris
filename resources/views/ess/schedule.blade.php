        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-5 space-y-4">
            <div class="px-4 pb-4 pt-2">
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div
                        class="bg-indigo-600 rounded-xl p-2.5 shadow-md shadow-indigo-200 text-center flex flex-col justify-center">
                ...
                <div class="relative group">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="flex flex-col items-center min-w-[3.2rem]">
                            <div
                                class="w-12 h-12 rounded-xl flex flex-col items-center justify-center border {{ $schedule->is_today ? 'bg-indigo-600 border-indigo-600 text-white shadow-md shadow-indigo-200' : 'bg-white border-gray-200 text-gray-600' }}">
                                <span
                                    class="text-[10px] font-medium uppercase {{ $schedule->is_today ? 'text-indigo-100' : 'text-gray-400' }}">
                        ...
                        <div
                            class="flex-grow p-3 rounded-xl border shadow-sm relative overflow-hidden {{ $schedule->card_style }}">
                            <div class="absolute left-0 top-0 bottom-0 w-1"
                                style="background-color: {{ $schedule->shift_color }}"></div>
                            ...
                            <div class="pl-2">
                                <div class="flex justify-between items-start mb-2">
                                    <div>
                                        ...
                                        @if ($schedule->is_today)
                                            <span
                                                class="inline-block mt-0.5 text-[9px] font-bold text-white bg-indigo-500 px-1.5 py-px rounded">TODAY</span>
                                        @endif
                                    </div>
                                ...
                                @if ($schedule->shift)
                                    <div
                                        class="flex items-center gap-3 text-xs mt-2 bg-gray-50 p-2 rounded-lg border border-gray-100">
                                ...
                                @else
                                    <div class="bg-red-50 p-2 rounded-lg border border-red-100 text-center">
                                        <span
                                            class="text-xs font-bold text-red-500 flex items-center justify-center gap-1">
